 ...
 *
     ...
     * @throws ApiError
     */
    static searchProjects(query, facets, index = 'relevance', offset, limit = 10) {
     ...
     * @throws ApiError
     */
    static modifyProject(idSlug, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PATCH',
            url: '/project/{id|slug}',
            path: {
     ...
     * @throws ApiError
     */
    static patchProjects(ids, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PATCH',
            url: '/projects',
            query: {
     ...
     * @throws ApiError
     */
    static changeProjectIcon(idSlug, ext, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static deleteProjectIcon(idSlug) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'DELETE',
            url: '/project/{id|slug}/icon',
            path: {
     ...
     * @throws ApiError
     */
    static checkProjectValidity(idSlug) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static addGalleryImage(idSlug, ext, featured, title, description, ordering, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static modifyGalleryImage(idSlug, url, featured, title, description, ordering) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PATCH',
            url: '/project/{id|slug}/gallery',
            path: {
     ...
     * @throws ApiError
     */
    static deleteGalleryImage(idSlug, url) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'DELETE',
            url: '/project/{id|slug}/gallery',
            path: {
     ...
     * @throws ApiError
     */
    static scheduleProject(idSlug, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
